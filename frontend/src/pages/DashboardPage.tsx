...
export function DashboardPage() {
  ...
  const loading = pLoading || sLoading || mLoading

  if (pLoading) return <AppLayout title="Inicio"><LoadingSpinner /></AppLayout>
        ...
        {loading ? (
          ...
          <>
            {summary ? (
              ...
              <Card>
                <p className="text-slate-500 text-sm text-center py-4">Sin datos de hoy</p>
              </Card>
            )}
