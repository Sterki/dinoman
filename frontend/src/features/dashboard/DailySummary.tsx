...
export function DailySummary({ summary, patientName }: Props) {
  ...
  return (
    <Card>
      <p className="text-sm font-medium text-slate-500 mb-1">{patientName} · Hoy</p>
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">carbohidratos consumidos</p>
        </div>
        <div className="text-right">
          <p className="text-2xl font-bold text-slate-700">{summary.mealCount}</p>
          <p className="text-xs text-slate-400">comidas</p>
        </div>
      </div>
